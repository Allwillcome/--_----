...
%标准化数据
writematrix(write_name, F_F_2, 'data', 'A2');
writematrix(write_name, H_txt(1), 'data', 'A1');
writematrix(write_name,qianjiao_horizontal_2, 'data', 'B2');
writematrix(write_name, H_txt(2), 'data', 'B1');
writematrix(write_name,qianjiao_vertical_2, 'data', 'C2');
writematrix(write_name, H_txt(3), 'data', 'C1');
writematrix(write_name, F_R_2, 'data', 'D2');
writematrix(write_name, H_txt(4), 'data', 'D1');
writematrix(write_name, houjiao_horizontal_2, 'data', 'E2');
writematrix(write_name, H_txt(5), 'data', 'E1');
writematrix(write_name, houjiao_vertical_2,'data', 'F2');
writematrix(write_name, H_txt(6), 'data', 'F1');
writematrix(write_name, zhuashou_vertical_2,'data', 'G2');
writematrix(write_name, H_txt(7), 'data', 'G1');
writematrix(write_name, zhuashou_horizontal_2,'data', 'H2');
writematrix(write_name, H_txt(8), 'data', 'H1');
writematrix(write_name, F_V_2 , 'data', 'I2');
writematrix(write_name, H_txt(9), 'data', 'I1');
writematrix(write_name,F_H_2 , 'data', 'J2');
writematrix(write_name, H_txt(10), 'data', 'J1');
writematrix(write_name, t , 'data', 'K2');
writematrix(write_name, H_txt(11), 'data', 'K1');
%Gun 写入excel
writematrix(write_name, gun , 'data', 'L2');
writematrix(write_name, H_txt(12), 'data', 'L1');

%后面是积分的写入，前面的力不除以体重
writematrix(write_name, jifen1 , 'data', 'M2');
writematrix(write_name, H_txt1(1), 'data', 'M1');
writematrix(write_name, jifen2 , 'data', 'N2');
writematrix(write_name, H_txt1(2), 'data', 'N1');
writematrix(write_name, jifen3 , 'data', 'O2');
writematrix(write_name, H_txt1(3), 'data', 'O1');
writematrix(write_name, jifen4 , 'data', 'P2');
writematrix(write_name, H_txt1(4), 'data', 'P1');
writematrix(write_name, jifen5 , 'data', 'Q2');
writematrix(write_name, H_txt1(5), 'data', 'Q1');
writematrix(write_name, jifen6 , 'data', 'R2');
writematrix(write_name, H_txt1(6), 'data', 'R1');
writematrix(write_name, jifen7 , 'data', 'S2');
writematrix(write_name, H_txt1(7), 'data', 'S1');
writematrix(write_name, jifen8 , 'data', 'T2');
writematrix(write_name, H_txt1(8), 'data', 'T1');
end
